...
Solicita la Service Role Key de forma interactiva
"""
...
if not SUPABASE_SERVICE_KEY:
    print("🔑 Necesitas la Service Role Key de Supabase para insertar datos")
    print("   Obténla en: https://supabase.com/dashboard/project/aoykpiievtadhwssugvs/settings/api")
    print("   Busca la sección 'service_role' key (⚠️  NUNCA la compartas públicamente)\n")
    SUPABASE_SERVICE_KEY = getpass.getpass("Ingresa la Service Role Key: ")

if not SUPABASE_SERVICE_KEY:
    print("❌ Error: Service Role Key es requerida")
    sys.exit(1)
